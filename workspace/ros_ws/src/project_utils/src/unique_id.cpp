...
// UniqueId::UniqueId(EntityType entType, long int val =-1)
//     :mValue(value)
// {
//     std::string category = toEntityString(entType);
//     if(isStringEqual(category, "none"))
//     {
//         throw std::runtime_error("[unique id]: category not found");
//     }
