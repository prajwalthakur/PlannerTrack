...
#pragma once
#include <project_utils/stop_watch.hpp>
#include <rclcpp/publisher.hpp>

#include <project_utils_msgs/msg/processing_time_node.hpp>
#include <project_utils_msgs/msg/processing_time_tree.hpp>
...
class ProcessingTimeNode : public std::enable_shared_from_this<ProcessingTimeNode>
{
  public:
	 ...
	 *
	 * @return project_utils_msgs::msg::ProcessingTimeTree Constructed ProcessingTimeTree
	 * message
	 */
	project_utils_msgs::msg::ProcessingTimeTree to_msg() const;
	 ...
	 *
	 * @return std::vector<std::shared_ptr<ProcessingTimeNode>> Vector of shared pointers to the
	 * child nodes
	 */
...
using ProcessingTimeDetail =
    project_utils_msgs::msg::ProcessingTimeTree;  //!< Alias for the ProcessingTimeTree
                                                  //!< message
...
class TimeKeeper
{
  ...
  private:
	...
	mpl_utils_system::StopWatch<std::chrono::milliseconds, std::chrono::microseconds,
