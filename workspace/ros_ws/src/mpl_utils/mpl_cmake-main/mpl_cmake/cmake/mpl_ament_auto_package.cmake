...
macro(mpl_ament_auto_package)
  # cSpell:ignore ARGN
  cmake_parse_arguments(_ARG_MPL_AMENT_AUTO_PACKAGE
    "INSTALL_TO_PATH"
    ""
    "INSTALL_TO_SHARE"
    ${ARGN})
  ...
  if(NOT ${PROJECT_NAME}_EXECUTABLES STREQUAL "")
    if(_ARG_MPL_AMENT_AUTO_PACKAGE_INSTALL_TO_PATH)
  ...
  foreach(_dir ${_ARG_MPL_AMENT_AUTO_PACKAGE_INSTALL_TO_SHARE})
  ...
  set(_unparsed_args ${_ARG_MPL_AMENT_AUTO_PACKAGE_UNPARSED_ARGUMENTS})
