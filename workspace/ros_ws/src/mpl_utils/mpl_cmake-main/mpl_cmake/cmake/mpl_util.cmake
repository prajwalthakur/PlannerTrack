...
function(project_get_target_name out_target_name)
    ...
    if($(curr_dir_name) MATCHES "unit_tests")
        ...
        set(${out_target_name} "${a_second_last_last_dir_name}unit_tests" PARENT_SCOPE)
    else()
...
function(project_add_unit_tests)
    ...
    set_target_properties(${_target_name} PROPERTIES FOLDER unit_tests)
endfunction()


# function(project_add_gtest)
