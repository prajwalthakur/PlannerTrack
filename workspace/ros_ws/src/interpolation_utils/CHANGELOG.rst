^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package interpolation_utils
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* chore(autoware_motion_utils, autoware_trajectory, interpolation_utils): add maintainers for packages (`#821 <https://github.com/autowarefoundation/autoware_core/issues/821>`_)
  * add maintainers for interpolation_utils
  * add maintainers for autoware_motion_utils
  * add maintainers for autoware_trajectory
  ---------
  Co-authored-by: Satoshi OTA <44889564+satoshi-ota@users.noreply.github.com>
* chore(interpolation_utils): add a maintainer (`#818 <https://github.com/autowarefoundation/autoware_core/issues/818>`_)
* feat(interpolation_utils): exposing access to coefficients (`#671 <https://github.com/autowarefoundation/autoware_core/issues/671>`_)
...
* fix(interpolation_utils): add missing dependencies (`#235 <https://github.com/autowarefoundation/autoware.core/issues/235>`_)
* feat: port interpolation_utils from autoware.universe (`#149 <https://github.com/autowarefoundation/autoware.core/issues/149>`_)
  Co-authored-by: Yutaka Kondo <yutaka.kondo@youtalk.jp>
  Co-authored-by: pre-commit-ci[bot] <66853113+pre-commit-ci[bot]@users.noreply.github.com>
