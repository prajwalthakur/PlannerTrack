...
void RectangularGeometry::setCollisionFootPrint(ptSharedPtr<CollisionFootPrint> collisionFootPrint)
{
...
void RectangularGeometry::step(const ptSharedPtr<stPose> & pose)
{
	mPose = pose;
...
void RectangularGeometry::printVertices() const
{
	...
	std::cerr << "front left :  " << "x " << fl.xCoord << ", y " << fl.yCoord << ", yaw " << fl.yaw
	          << '\n';

	std::cerr << "front right: " << "x " << fr.xCoord << ", y " << fr.yCoord << ", yaw " << fr.yaw
	          << '\n';

	std::cerr << "rear left  : " << "x " << rl.xCoord << ", y " << rl.yCoord << ", yaw " << rl.yaw
	          << '\n';

	std::cerr << "rear right : " << "x " << rr.xCoord << ", y " << rr.yCoord << ", yaw " << rr.yaw
	          << '\n';
}
