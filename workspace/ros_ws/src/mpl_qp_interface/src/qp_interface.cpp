...
{
void QPInterface::initializeProblem(const Eigen::MatrixXd & P, const Eigen::MatrixXd & A,
...
std::vector<double> QPInterface::optimize(const Eigen::MatrixXd & P, const Eigen::MatrixXd & A,
    const std::vector<double> & q, const std::vector<double> & l, const std::vector<double> & u)
{
