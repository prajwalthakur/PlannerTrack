...
TEST(TestCscMatrixConv, Nominal)
{
	...
	square2 << 10.0, 0.0, 0.0, 0.0, -2.0, 0.0, 3.0, 9.0, 0.0, 0.0, 0.0, 3.0, 0.0, 7.0, 8.0, 7.0,
	    0.0, 0.0, 3.0, 0.0, 8.0, 7.0, 5.0, 0.0, 0.0, 8.0, 0.0, 9.0, 9.0, 13.0, 0.0, 4.0, 0.0, 0.0,
	    2.0, -1.0;
...
TEST(TestCscMatrixConv, Print)
{
	...
	using mpl::qp_interface::calCSCMatrixTrapezoidal;
	using mpl::qp_interface::CSC_Matrix;
	using mpl::qp_interface::printCSCMatrix;
	Eigen::MatrixXd square1(2, 2);
	Eigen::MatrixXd rect1(1, 2);
	square1 << 1.0, 2.0, 2.0, 4.0;
	rect1 << 0.0, 1.0;
