...
#include "mpl_qp_interface/qp_interface.hpp"
...
class OSQPInterface : public QPInterface
{
  public:
	...
	OSQPInterface(const bool enable_warm_start = false,
	    const int max_iteration = OSQP_MAX_ITERATION,
	...
	std::vector<double> optimize(CSC_Matrix P, CSC_Matrix A, const std::vector<double> & q,
	    const std::vector<double> & l, const std::vector<double> & u);
  ...
  private:
	...
	void initializeProblemImpl(const Eigen::MatrixXd & P, const Eigen::MatrixXd & A,
	    const std::vector<double> & q, const std::vector<double> & l,
	    const std::vector<double> & u) override;

	void initializeCSCProblemImpl(CSC_Matrix P, CSC_Matrix A, const std::vector<double> & q,
	    const std::vector<double> & l, const std::vector<double> & u);
