...
class QPInterface
{
  public:
	...
	std::vector<double> optimize(const Eigen::MatrixXd & P, const Eigen::MatrixXd & A,
  ...
  protected:
	...
	void initializeProblem(const Eigen::MatrixXd & P, const Eigen::MatrixXd & A,
	    const std::vector<double> & q, const std::vector<double> & l,
	    const std::vector<double> & u);

	virtual void initializeProblemImpl(const Eigen::MatrixXd & P, const Eigen::MatrixXd & A,
	    const std::vector<double> & q, const std::vector<double> & l,
